Create the skeleton project - Latest WildFly Documentation
==========================================================
...
link:Create_the_skeleton_project.html#108626363_Createtheskeletonproject-Testingtheparsers[Testing
the parsers] section.
