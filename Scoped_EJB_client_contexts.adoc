Scoped EJB client contexts - Latest WildFly Documentation
=========================================================
...
WildFly 8 introduced the EJB client API for managing remote EJB
...
In case of remote clients which run within another WildFly 8 instance,
...
that don't run within another WildFly 8 instance) for some of the next
...
the bean more than once, but wants to connect to the WildFly 8 server
