...
image:images/download/attachments/557124/ImportExistingMavenProject.png[images/download/attachments/557124/ImportExistingMavenProject.png]

You project view should look like this

image:images/download/attachments/557124/ProjectExplorerA.png[images/download/attachments/557124/ProjectExplorerA.png]

Then go to File|New|Android Project and fill out the first wizard page
like this

image:images/download/attachments/557124/NewAndroidProject.png[images/download/attachments/557124/NewAndroidProject.png]

Click Finish. Next, go to Project|Properties|Build Path|Libraries and
add these external libraries to your android project.

image:images/download/attachments/557124/AndroidLibraries.png[images/download/attachments/557124/AndroidLibraries.png]

You final project view should look like this

image:images/download/attachments/557124/ProjectExplorerB.png[images/download/attachments/557124/ProjectExplorerB.png]
...
image:images/download/attachments/557124/CreateAVD_.png[images/download/attachments/557124/CreateAVD_.png]

Now go to Run|Configuration to create a new run configuration for the
client app.

image:images/download/attachments/557124/RunConfiguration.png[images/download/attachments/557124/RunConfiguration.png]
...
image:images/download/attachments/557124/2_2_HVGA_Initial.png[images/download/attachments/557124/2_2_HVGA_Initial.png]

image:images/download/attachments/557124/2_2_HVGA_Next.png[images/download/attachments/557124/2_2_HVGA_Next.png]

image:images/download/attachments/557124/2_2_HVGA_Final.png[images/download/attachments/557124/2_2_HVGA_Final.png]
...
image:images/download/attachments/557124/NoBooks.png[images/download/attachments/557124/NoBooks.png]
...
image:images/download/attachments/557124/HostSettings.png[images/download/attachments/557124/HostSettings.png]

When going back to the application using the little back arrow next to
Menu, you should see a list of books.

image:images/download/attachments/557124/ListOfBooks.png[images/download/attachments/557124/ListOfBooks.png]
