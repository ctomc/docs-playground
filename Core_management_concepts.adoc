...
See link:#src-557076_Coremanagementconcepts-Descriptions[#Descriptions]
...
link:#src-557076_Coremanagementconcepts-Address[_types_ of children] a
resource supports (e.g. `connector` for the web subsystem resource) can
be obtained by querying the resource's description (see
link:#src-557076_Coremanagementconcepts-Descriptions[#Descriptions]
