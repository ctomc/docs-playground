Porting the Order Application from EAP 5.1 to WildFly 8 - Latest WildFly
Documentation
======================================================================================

[[porting-the-order-application-from-eap-5.1-towildfly-8]]
Porting the Order Application from EAP 5.1 to WildFly 8
-------------------------------------------------------

Andy Miller ported an example Order application that was used for
performance testing from EAP 5.1 to WildFly 8. These are the notes he
