Java API for XML Web Services (JAX-WS) - Latest WildFly Documentation
=====================================================================
...
consult the
https://docs.jboss.org/author/display/AS71/JAX-WS+User+Guide[user
guide].
...
Even though detailed knowledge of web service meta data is not
required,  it will definitely help if you make yourself familiar with
it.  For further information see
