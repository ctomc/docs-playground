...
include::extending-wildfly-guide/Example_subsystem.adoc[]

include::extending-wildfly-guide/Working_with_WildFly_Capabilities.adoc[]

include::extending-wildfly-guide/Domain_Mode_Subsystem_Transformers.adoc[]

include::extending-wildfly-guide/Key_Interfaces_and_Classes_Relevant_to_Extension_Developers.adoc[]

include::extending-wildfly-guide/WildFly_JNDI_Implementation.adoc[]

include::extending-wildfly-guide/CLI_extensibility_for_layered_products.adoc[]
